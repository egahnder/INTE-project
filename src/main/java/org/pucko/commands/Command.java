...
public abstract class Command implements OutputHandler {
     ...
     * @param outputHandler Where the output and errors generated by the command should be sent.
     */
    public Command(ArrayList<String> args, WorkingDirectory workingDirectory, OutputHandler outputHandler) {
        this(args, workingDirectory, outputHandler, outputHandler);
    }
