...
public abstract class Command implements OutputHandler {
     ...
     * @param inputHandler
     */
    public Command(ArrayList<String> args, WorkingDirectory workingDirectory, OutputHandler outputHandler, OutputHandler errorHandler, InputHandler inputHandler) {
        this.args = args;
