...
public class DefaultCommand extends Command {
     ...
     */
    public DefaultCommand(ArrayList<String> args, WorkingDirectory workingDirectory, OutputHandler outputHandler, OutputHandler errorHandler, InputHandler inputHandler) {
